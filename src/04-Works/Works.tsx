...
export type WorkDataType = typeof jsonState.work2;
    ...
    <section id={'works'} className={css.worksBlock}>
      <div className={`${styleContainer.container} ${css.worksContainer}`}>
        ...
        <div className={css.works}>
          <Work image={work7.workImg} title={work7.headerBlock.header} linkType={'gallery'} data={work7} />
          <Work image={work6.workImg} title={work6.headerBlock.header} linkType={'gallery'} data={work6} />
          ...
          <Work image={work1.workImg} title={work1.headerBlock.header} linkType={'External Link'} data={work1} />
        </div>
      </div>
    </section>
  );
